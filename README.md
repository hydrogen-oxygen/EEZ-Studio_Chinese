...
-   [官方网址](https://www.envox.eu/studio/studio-introduction/)
...
[FAQ地址](https://github.com/eez-open/studio/wiki/FAQ)

**问**: Where is the database file by default?
**答**: Depending on the operating system, it can be:
...
**问**: Where are the IEXTs (Instrument EXTensions) used to access T&M instruments stored?
**答**: Depending on the operating system, it can be:
